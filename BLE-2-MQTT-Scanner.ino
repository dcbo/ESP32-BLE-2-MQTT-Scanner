...
#define MQTT_SERVER   "YOUR_MQTT_BROKER_HERE"    // IP or Name of MQTT-Server
#define MQTT_PORT     1883                       // Port of MQTT-Server  
#define MQTT_NAME     "YOUR_MQTT_CLIENT_HERE"    // MQTT-Clientname
...
void setup() {
    ...
    Serial.println("=================");
    Serial.println("2020 by Dario Carluccio");    
